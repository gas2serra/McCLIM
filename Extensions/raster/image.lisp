...
(defgeneric coerce-image (image image-class-or-type &optional family))
(defgeneric clone-image (image image-class-or-type  &optional family))
...
(defgeneric crop-image (image sx sy width height &optional image-class-or-type family))
(defgeneric coerce-alpha-channel (image &optional image-class-or-type family))
(defgeneric clone-alpha-channel (image &optional image-class-or-type family))
