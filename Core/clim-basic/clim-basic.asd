(defsystem #:clim-basic
  ...
  ((:file "setf-star")
   ...
   (:file "sheet-core" :depends-on ("decls" "protocol-classes" "multiprocessing" "utils" "transforms" "regions"))
   (:file "sheet-relationships" :depends-on ("decls" "protocol-classes" "multiprocessing" "utils" "transforms" "regions"))
   (:file "sheets" :depends-on ("decls" "protocol-classes" "sheet-core" "sheet-relationships" "multiprocessing" "utils" "transforms" "regions"))
