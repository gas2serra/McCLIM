(defsystem #:clim-basic
  ...
  ((:file "setf-star")
   ...
   (:file "sheet-protocols" :depends-on ("decls" "protocol-classes" "multiprocessing" "utils" "transforms" "regions"))
   (:file "sheet-core" :depends-on ("decls" "sheet-protocols" "protocol-classes" "multiprocessing" "utils" "transforms" "regions"))
   (:file "sheets" :depends-on ("decls" "protocol-classes" "sheet-core" "multiprocessing" "utils" "transforms" "regions"))
   ...
   (:file "port-protocols" :depends-on ("decls" "protocol-classes" "multiprocessing" "events" "sheets" "pixmap" "utils"))
   (:file "port-core" :depends-on ("decls" "port-protocols" "protocol-classes" "multiprocessing" "events" "sheets" "pixmap" "utils"))
   
   (:file "ports" :depends-on ("decls" "port-core" "protocol-classes" "multiprocessing" "events" "sheets" "pixmap" "utils"))
